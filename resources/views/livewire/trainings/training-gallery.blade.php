<div>
    ...
    <div class="flex justify-end">
        <button type="button" onclick="location.href='{{ route('TrainingForm') }}'" class="text-white mb-8 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Activity</button>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                    @foreach ($TrainingData as $data)
                        <div>
                            <a href="{{route('TrainingView', ['index' => $data->id])}}"><img class="h-auto max-w-full rounded-lg" src="{{ asset('storage/' . $data->training_photo) }}" alt=""></a>
                        </div>
                    @endforeach
                </div>
