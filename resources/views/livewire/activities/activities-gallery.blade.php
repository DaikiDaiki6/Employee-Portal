    ...
    <section class="bg-white  dark:bg-gray-900 pb-24 px-8  rounded-lg">
        <div class=" px-1 mx-auto pt-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-4 w-full object-contain">
                    @foreach ($ActivitiesData as $data)
                        <div>
                            <a href="{{route('ActivitiesView', ['index' => $data->id])}}"><img class="h-auto w-full object-none rounded-lg" src="{{ asset('storage/' . $data->poster) }}" alt=""></a>
                            {{-- <a href="{{route('ActivitiesView', ['index' => $data->id])}}"><img class="h-auto max-w-full rounded-lg" src="{{ asset('storage/photos/activities/event/wit8DBv1K4oXAZFvuo318sB0grDAUQFJe8HTjmvN.jpg') }}" alt=""></a> --}}
