<div class="main-content">
    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 rounded-lg dark:border-gray-700 mt-14">
           ...
           <div class="grid grid-cols-2 w-1/3 gap-4">
                <div class="p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                  <h4 class="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white whitespace-nowrap">Vacation Credits</h4>
                  <p class="font-normal text-3xl text-gray-700 dark:text-gray-400">{{$vacationCredits}}</p>
                </div>
                <div class="p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                  <h4 class="mb-2 text-lg font-bold tracking-tight text-gray-900 dark:text-white">Sick Credits</h4>
            ...
            <div class="relative shadow-md   overflow-x-auto sm:rounded-lg bg-white pb-4 w-full" >
                        ...
                        <div>
                            ...
                            <tbody>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    @elseif($leaverequest->status == "Accepted")
                                        <th scope="row" class="px-6 py-4 text-center font-medium text-gray-900 whitespace-nowrap dark:text-white capitalize">
                                    ...
                                    <td class="px-6 py-4 text-center">
                                      ...
                                      <td class="relative items-center text-center py-4">
                                            ...
                                            <div class="hidden absolute top-0 right-0 mt-2 z-50 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700" id="dropdown{{$loop->index}}">
                                                <!-- Dropdown content -->
