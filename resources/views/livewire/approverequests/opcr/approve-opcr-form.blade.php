                            ...
                            <div class="block w-full col-span-3 p-6 pb-8 mb-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                <ul class="text-sm font-medium text-right text-gray-500 border border-gray-300 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800" id="defaultTab" data-tabs-toggle="#defaultTabContent" role="tablist">
                                    <li class="">
                                        ...
                                        type="button" name="add" value="removeCoreFunction({{$index}})" wire:confirm="Are you sure you want to delete this function?"
                                ...
                                <div class="grid grid-cols-1 col-span-3 gap-4  border min-[1150px]:grid-cols-5 border-gray-200 p-4" >
                                    <div class="grid col-span-3 gap-4 sm:grid-cols-1 min-[900px]:grid-cols-3">
                                        <div>
                                            ...
                                            <textarea disabled type="text" rows="10" id="coreFunctions[{{$index}}][output]"  name="coreFunctions[{{$index}}][output]" wire:model="coreFunctions.{{$index}}.output" value=""   class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            </textarea>
                                            ...
                                            <div class="flex-wrap pb-5 ">
                                               ...
                                               <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <div class="w-full">
                                                        ...
                                                        <select disabled id="smtpQ" name="coreFunctions[{{$index}}][Q]" wire:model.live="coreFunctions.{{$index}}.Q"
                                                    ...
                                                    <div class="w-full">
                                                        ...
                                                        <select disabled id="smtpE" name="coreFunctions[{{$index}}][E]" wire:model.live="coreFunctions.{{$index}}.E"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                            <option selected>Pick</option>
                                                            <option value="5">5</option>
                                                            <option value="4">4</option>
                                                    ...
                                                    <div class="w-full ">
                                                        ...
                                                        <select disabled id="smtpT" name="coreFunctions[{{$index}}][T]" wire:model.live="coreFunctions.{{$index}}.T"
                                                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                            <option selected>Pick</option>
                                                            <option value="5">5</option>
                                                            <option value="4">4</option>
