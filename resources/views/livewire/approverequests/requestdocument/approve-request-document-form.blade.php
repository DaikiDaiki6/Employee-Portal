<div>
    <nav class="flex mb-4" aria-label="Breadcrumb">
        ...
        <li>
            ...
            <a href="{{route('ipcrtable')}}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Study Permit</a>
            </div>
        </li>
                        ...
                        <div class="grd grid-cols-1 p-6 mt-5 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-4">
                                ...
                                @if(in_array('Service Record', $requests))
                                 ...
                                 <div class="grid grid-cols-1 gap-4">
                                    <div class="col-span-2 grid grid-cols-1 p-4 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                        ...
                                        <div class="grid grid-cols-1 items-center justify-center w-full">
                                            <label for="service_record" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                            @if($service_record)
                                ...
                                <div class="col-span-2 grid grid-cols-1 p-4 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                    ...
                                    <div class="grid grid-cols-1 items-center justify-center w-full">
                                        <label for="milc_certification" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <div class="col-span-2 grid grid-cols-1 p-4 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                        ...
                                        class="block text-sm font-medium text-gray-900 dark:text-white">MILC Certification<span class="text-red-600">*</span></label>
                                        <div class="grid grid-cols-1 items-center justify-center w-full">
                                            <label for="others" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                            @if($others)
