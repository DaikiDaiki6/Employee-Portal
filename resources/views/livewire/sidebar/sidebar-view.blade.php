   ...
   <nav class="fixed top-0 z-50 w-full pb-4 bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
       <div class="flex flex-wrap justify-between items-center">
           ...
           <div class="flex items-center lg:order-2">
               ...
               <!-- Dropdown menu -->
               <div  wire:poll.visible.60s class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700" id="notification-dropdown">
                   ...
                   <div>
                    @foreach (auth()->user()->notifications->take(7) as $notification)
                        ...
                        @elseif ($notificationType === 'LeaveRequest')
                            ...
                            <div class="flex-shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-11 h-11 text-gray-500">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" />
                                </svg>
                        @elseif ($notificationType === 'StudyPermit')
                        ...
                        @elseif ($notificationType === 'TeachPermit')
                        ...
                        @elseif ($notificationType === 'RequestDocument')
                        ...
                        @endif
                                <div class="flex absolute justify-center items-center ml-6 -mt-5 w-5 h-5 rounded-full border border-white bg-white dark:border-gray-700">
