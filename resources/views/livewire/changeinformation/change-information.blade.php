                ...
                <div class="grid grid-cols-1 col-span-3 p-6 gap-4 mt-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="grid grid-cols-1 items-start min-[800px]:grid-cols-2 gap-4">
                            {{-- 1 --}}
                            <div id="emp_photo_container" class="grid grid-cols-1  p-4 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                <label for="emp_photo"
                                class="block text-sm font-medium text-gray-900 dark:text-white"> 1. Employee Photo <span class="text-red-600">*</span></label>
                                @if($emp_photo)
                                <div class="grid grid-cols-1 items-center justify-center w-full">
                                    <label for="emp_photo" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                        <img src="{{ $emp_photo->temporaryUrl() }}" class="w-full h-full object-contain" alt="Uploaded File">
                                        <input id="emp_photo" type="file" class="hidden" wire:model.blur="emp_photo">
                                    </label>
                                </div>
                                @else
                                <div class="grid grid-cols-1 items-center justify-center w-full ">
                                ...
                                @error('emp_photo')
                                    <div class="transition transform alert alert-danger text-sm mb-1"
                                        x-data x-init="document.getElementById('emp_photo_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('emp_photo_container').focus();">
                                        <span class="text-red-500 text-xs "> {{$message}}</span>
                                    </div> 
                                @enderror
                            </div>
                            ...
                            <div id="emp_diploma_container"
                                ...
                                <label for="emp_diploma"
                                    class="block text-sm font-medium text-gray-900 dark:text-white">2. Diploma<span class="text-red-600">*</span></label>
                        ...
                        <div class="grid grid-cols-1 items-start min-[800px]:grid-cols-2 gap-4">
                            ...
                            <div id="emp_TOR_container"
                                class="grid grid-cols-1  p-4 gap-4 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                <label for="emp_TOR"
                                    class="block text-sm font-medium text-gray-900 dark:text-white">3. Transcript of Record<span class="text-red-600">*</span></label>
                                <div class="grid grid-cols-1   w-full">
                                @if ($emp_TOR)
                                    @foreach ($emp_TOR as $index => $item)
                                        @foreach ($item as $insideIndex => $file)
                                            ...
                                            @error('emp_TOR.' . $index .  '.' .  $insideIndex)
                                                <div class="transition transform alert alert-danger text-sm mb-1"
                                                        x-data x-init="document.getElementById('emp_TOR_container').scrollIntoView({ behavior: 'smooth', block: 'center' }); document.getElementById('emp_TORr_container').focus();">
                                                    <span class="text-red-500 text-xs "> {{$message}}</span>
                                                </div> 
                                            @enderror
                                        @endforeach
                            ...
                            <div id="emp_cert_of_trainings_seminars_container"
                                ...
                                <label for="emp_cert_of_trainings_seminars"
                                    class="block text-sm font-medium text-gray-900 dark:text-white">4. Certificate of Trainings and Seminars <span class="text-red-600">*</span></label>
                                <div class="grid grid-cols-1   w-full">
                        ...
                        <div class="grid grid-cols-1 items-start min-[800px]:grid-cols-2 gap-4">
                            ...
                            <div id="emp_auth_copy_of_csc_or_prc_container"
                                ...
                                <label for="emp_auth_copy_of_csc_or_prc"
                                    class="block text-sm font-medium text-gray-900 dark:text-white">5. Authenticated Copy of CSC OR PRC</label>
                                <div class="grid grid-cols-1   w-full">
                            ...
                            <div id="emp_auth_copy_of_prc_board_rating_container"
                                ...
                                <label for="emp_auth_copy_of_prc_board_rating"
                                    class="block text-sm font-medium text-gray-900 dark:text-white">6. Authorized Copy of Prc Board Rating</label>
                                <div class="grid grid-cols-1   w-full">
                        ...
                        <div class="grid grid-cols-1 items-start min-[800px]:grid-cols-2 gap-4">
                            ...
                            <div id="emp_med_certif_container"
                                ...
                                <label for="emp_med_certif"
                                    class="block text-sm font-medium text-gray-900 dark:text-white">7. Medical Certificate</label>
                                <div class="grid grid-cols-1   w-full">
                                    @if ($emp_med_certif)
                            ...
                            <label for="emp_nbi_clearance"
                                class="block text-sm font-medium text-gray-900 dark:text-white">8. NBI Clearance</label>
                            <div class="grid grid-cols-1   w-full">
                        ...
                        <div class="grid grid-cols-1 items-start min-[800px]:grid-cols-2 gap-4">
                            ...
                            <div id="emp_psa_birth_certif_container"
                                ...
                                <label for="emp_psa_birth_certif"
                                    class="block text-sm font-medium text-gray-900 dark:text-white">9. PSA Birth Certificate</label>
                                <div class="grid grid-cols-1   w-full">
                            ...
                            <label for="emp_psa_marriage_certif"
                                class="block text-sm font-medium text-gray-900 dark:text-white">10. PSA Marriage Certificate</label>
                            <div class="grid grid-cols-1   w-full">
                        ...
                        <div class="grid grid-cols-1 items-start min-[800px]:grid-cols-2 gap-4">
                            ...
                            <div id="emp_service_record_from_other_govt_agency_container"
                                ...
                                <label for="emp_service_record_from_other_govt_agency"
                                    class="block text-sm font-medium text-gray-900 dark:text-white">11. Service Record From Other Agency</label>
                                <div class="grid grid-cols-1   w-full">
                            ...
                            <label for="emp_approved_clearance_prev_employer"
                                class="block text-sm font-medium text-gray-900 dark:text-white">12. Approved Clearance from Previous Employer</label>
                            <div class="grid grid-cols-1   w-full">
