<div>
    ...
    <h2 class="mb-4 text-3xl font-bold leading-none tracking-tight text-gray-900 md:text-3xl dark:text-white">Add a new Study Permit</h2>
                                ...
                                <div class="grid grid-cols-1 w-full col-span-3 gap-4 min-[1000px]:grid-cols-2 p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700 ">
                                    ...
                                    <div class="grid grid-cols-1 gap-4 p-6 bg-white border border-gray-200 rounded-lg shadow  dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <div>
                                            ...
                                            class="block  pt-4 text-sm font-medium  text-gray-900 dark:text-white">Indicate the degree program and school where employee intends to enroll. (Please indicate address and contact numbers if outside the University.) <span class="text-red-600">*</span></label>
                                                    ...
                                                    @foreach ($cover_memo as $index => $item)
                                                        @if(is_array($item))
                                                            @foreach ($item as $insideIndex => $image)
                                                                ...
                                                                <input id="cover_memo_{{$index}}" type="file" class="hidden" wire:model.blur="cover_memo.{{$index}}" multiple>
                                                                </label>
                                                            @endforeach
                                                        @else
